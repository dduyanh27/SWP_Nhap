...
<head>
    ...
    <title>User Management — VMFruit Admin</title>
    <meta name="description" content="Manage users in VMFruit admin panel.">
    ...
    <main class="admin-main">
        ...
        <div class="admin-toolbar">
            <div class="toolbar-left">
                <select id="roleFilter" name="role" class="admin-select"
                ...
                <select id="statusFilter" name="status" class="admin-select"
                        onchange="applyUserFilters()">
                    <option value=""        ${param.status == ''        ? 'selected' : ''}>All Statuses</option>
